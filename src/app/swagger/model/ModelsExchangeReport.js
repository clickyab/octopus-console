 ...
 */
  ...
  /**
   * The ModelsExchangeReport model module.
   * @module model/ModelsExchangeReport
   * @version 1.0.0
   */

  /**
   * Constructs a new <code>ModelsExchangeReport</code>.
   * @alias module:model/ModelsExchangeReport
   * @class
   */
  ...
  /**
   * Constructs a <code>ModelsExchangeReport</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/ModelsExchangeReport} obj Optional instance to populate.
   * @return {module:model/ModelsExchangeReport} The populated <code>ModelsExchangeReport</code> instance.
   */
