 ...
 */
  ...
  /**
   * The RoutesDemandReportResponseData model module.
   * @module model/RoutesDemandReportResponseData
   * @version 1.0.0
   */

  /**
   * Constructs a new <code>RoutesDemandReportResponseData</code>.
   * @alias module:model/RoutesDemandReportResponseData
   * @class
   */
  ...
  /**
   * Constructs a <code>RoutesDemandReportResponseData</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/RoutesDemandReportResponseData} obj Optional instance to populate.
   * @return {module:model/RoutesDemandReportResponseData} The populated <code>RoutesDemandReportResponseData</code> instance.
   */
